...
TIMESTAMP INF myLogger: now using jsonx formatting: {foo:1,bar:2}
...
function formattingTest() {
    ...
    Duktape.Logger.prototype.fmt = function(val) { return Duktape.enc('jsonx', val); };
    logger.info('now using jsonx formatting:', {foo:1, bar:2});
