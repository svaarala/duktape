/* A window.fetch polyfill for Duktape */
...
(function() {
	...
	def(self.DOMException, "DOMException", true, void 0)
	try {
	...
	def(Headers, "Headers", true, void 0)
	def(Request, "Request", true, void 0)
	def(Response, "Response", true, void 0)
	def(fetch, "fetch", true, void 0)
})()
