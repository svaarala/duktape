...
const configureCommandSpec = createBareObject({
    ...
    options: createBareObject({
        ...
        'output-directory': { short: 'o', type: 'path', default: void 0, required: true, description: 'Directory for output files (created automatically, must not exist)' },
...
function configureCommand(cmdline, autoDuktapeRoot) {
    ...
    var outputDirectory = assert(opts['output-directory']);
