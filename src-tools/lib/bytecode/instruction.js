...
function decodeInstruction(ins, pc, dukOpcodes) {
    ...
    if (op.args) {
        for (let i = 0; i < op.args.length; i++) {
            ...
            case 'A_H':
                rawArgs.push(A);
                args.push('0x' + A.toString(16));
                break;
            case 'A_I':
                rawArgs.push(A);
                args.push(A.toString(10));
                break;
            case 'A_B':
                rawArgs.push(A);
                args.push(A ? 'true' : 'false');
                break;
            case 'B_RC':
                rawArgs.push(B);
                args.push((Bconst ? 'c' : 'r') + B);
                break;
            case 'B_R':
                rawArgs.push(B);
                args.push('r' + B);
            ...
            case 'B_H':
                rawArgs.push(B);
                args.push('0x' + B.toString(16));
                break;
            case 'B_I':
                rawArgs.push(B);
                args.push(B.toString(10));
                break;
            case 'C_RC':
                rawArgs.push(C);
                args.push((Cconst ? 'c' : 'r') + C);
                break;
            case 'C_R':
                rawArgs.push(C);
                args.push('r' + C);
            ...
            case 'C_H':
                rawArgs.push(C);
                args.push('0x' + C.toString(16));
                break;
            case 'C_I':
                rawArgs.push(C);
                args.push(C.toString(10));
                break;
            case 'BC_R':
                rawArgs.push(BC);
                args.push('r' + BC);
            ...
            case 'BC_H':
                rawArgs.push(BC);
                args.push('0x' + BC.toString(16));
                break;
            case 'BC_I':
                rawArgs.push(BC);
                args.push(BC.toString(10));
                break;
            case 'ABC_H':
                rawArgs.push(ABC);
                args.push(ABC.toString(16));
                break;
            case 'ABC_I':
                rawArgs.push(ABC);
                args.push(ABC.toString(10));
                break;
            case 'BC_LDINT':
                rawArgs.push(BC);
                args.push(BC - (1 << 15));
