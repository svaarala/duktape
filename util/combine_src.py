...
def createCombined(files, extinc, intinc, duk_version):
	res = []
	...
	res.append(' *  See Duktape LICENSE.txt for copyright and licensing information.')
	res.append(' */')
	res.append('')
...
def main():
	...
	final = createCombined(files, extinc, intinc, duk_version)
	f = open(outname, 'wb')
	f.write(final)
	f.close()
