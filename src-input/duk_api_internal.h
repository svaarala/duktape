...
DUK_INTERNAL_DECL void duk_pop_2_unsafe(duk_context *ctx);
DUK_INTERNAL_DECL void duk_pop_3_unsafe(duk_context *ctx);
DUK_INTERNAL_DECL void duk_pop_n_nodecref_unsafe(duk_context *ctx, duk_idx_t count);
DUK_INTERNAL_DECL void duk_pop_nodecref_unsafe(duk_context *ctx);
DUK_INTERNAL_DECL void duk_pop_2_nodecref_unsafe(duk_context *ctx);
DUK_INTERNAL_DECL void duk_pop_3_nodecref_unsafe(duk_context *ctx);
DUK_INTERNAL_DECL void duk_pop_undefined(duk_context *ctx);
