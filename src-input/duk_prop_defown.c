...
DUK_LOCAL_DECL duk_bool_t duk__prop_defown_strkey_unsafe(duk_hthread *thr, duk_hobject *obj, duk_hstring *key, duk_idx_t idx_desc, duk_uint_t defprop_flags);
DUK_LOCAL_DECL duk_bool_t duk__prop_defown_strkey_safe(duk_hthread *thr, duk_hobject *obj, duk_hstring *key, duk_idx_t idx_desc, duk_uint_t defprop_flags);

DUK_LOCAL_DECL duk_bool_t duk__prop_defown_idxkey_unsafe(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags);
DUK_LOCAL_DECL duk_bool_t duk__prop_defown_idxkey_safe(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags);
...
DUK_LOCAL duk_bool_t duk__prop_defown_error_shared(duk_hthread *thr, duk_uint_t defprop_flags) {
	if (defprop_flags & DUK_DEFPROP_THROW) {
		DUK_TYPE_ERROR(thr, "cannot (re)define property of object");
	}
	return 0;
}
DUK_LOCAL DUK_COLD duk_bool_t duk__prop_defown_error_obj_idxkey(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_uint_t defprop_flags) {
	DUK_UNREF(obj);
	DUK_UNREF(idx);
	return duk__prop_defown_error_shared(thr, defprop_flags);
}
DUK_LOCAL DUK_COLD duk_bool_t duk__prop_defown_error_obj_strkey(duk_hthread *thr, duk_hobject *obj, duk_hstring *key, duk_uint_t defprop_flags) {
	DUK_UNREF(obj);
	DUK_UNREF(key);
	return duk__prop_defown_error_shared(thr, defprop_flags);
}
 ...
 * be zero).
 */
DUK_LOCAL duk_bool_t duk__prop_defown_write_new_slot(duk_hthread *thr, duk_idx_t idx_desc, duk_uint_t defprop_flags, duk_propvalue *pv_slot, duk_uint8_t *attr_slot) {
	if (DUK_UNLIKELY(defprop_flags & (DUK_DEFPROP_HAVE_GETTER | DUK_DEFPROP_HAVE_SETTER))) {
		...
		*attr_slot = (defprop_flags & DUK_DEFPROP_WEC);
...
DUK_LOCAL duk_bool_t duk__prop_defown_update_convert_to_accessor(duk_hthread *thr, duk_idx_t idx_desc, duk_uint_t defprop_flags, duk_propvalue *pv_slot, duk_uint8_t *attr_slot, duk_uint8_t attrs, duk_uint8_t curr_configurable, duk_uint_t have_shifted) {
	duk_tval tv_old;
...
DUK_LOCAL duk_bool_t duk__prop_defown_update_convert_to_data(duk_hthread *thr, duk_idx_t idx_desc, duk_uint_t defprop_flags, duk_propvalue *pv_slot, duk_uint8_t *attr_slot, duk_uint8_t attrs, duk_uint8_t curr_configurable, duk_uint_t have_shifted) {
	duk_hobject *old_get;
	duk_hobject *old_set;
...
DUK_LOCAL duk_bool_t duk__prop_defown_update_keep_accessor(duk_hthread *thr, duk_idx_t idx_desc, duk_uint_t defprop_flags, duk_propvalue *pv_slot, duk_uint8_t *attr_slot, duk_uint8_t attrs, duk_uint8_t curr_configurable, duk_uint_t have_shifted) {
	duk_hobject *new_get = NULL;
	duk_hobject *new_set = NULL;
...
DUK_LOCAL duk_bool_t duk__prop_defown_update_keep_data(duk_hthread *thr, duk_idx_t idx_desc, duk_uint_t defprop_flags, duk_propvalue *pv_slot, duk_uint8_t *attr_slot, duk_uint8_t attrs, duk_uint8_t curr_configurable, duk_uint_t have_shifted) {
	have_shifted &= DUK_DEFPROP_WEC;  /* Restrict HAVE flags to WEC. */
	if (DUK_UNLIKELY(!curr_configurable && !(defprop_flags & DUK_DEFPROP_FORCE))) {
		/* Configurable: must not change.
		 * Enumerable: must not change.
 ...
 */
DUK_LOCAL duk_bool_t duk__prop_defown_update_existing_slot(duk_hthread *thr, duk_idx_t idx_desc, duk_uint_t defprop_flags, duk_propvalue *pv_slot, duk_uint8_t *attr_slot) {
	duk_uint8_t attrs;
	...
	if (DUK_UNLIKELY(attrs & DUK_PROPDESC_FLAG_ACCESSOR)) {
		...
		if (defprop_flags & (DUK_DEFPROP_HAVE_VALUE | DUK_DEFPROP_HAVE_WRITABLE)) {
			...
			return duk__prop_defown_update_convert_to_data(thr, idx_desc, defprop_flags, pv_slot, attr_slot, attrs, curr_configurable, have_shifted);
		} else {
			/* Keep as an accessor. */
			return duk__prop_defown_update_keep_accessor(thr, idx_desc, defprop_flags, pv_slot, attr_slot, attrs, curr_configurable, have_shifted);
		}
	} else {
		if (DUK_UNLIKELY(defprop_flags & (DUK_DEFPROP_HAVE_GETTER | DUK_DEFPROP_HAVE_SETTER))) {
			/* Convert from data property to accessor. */
			return duk__prop_defown_update_convert_to_accessor(thr, idx_desc, defprop_flags, pv_slot, attr_slot, attrs, curr_configurable, have_shifted);
		} else {
			/* Keep as a data property. */
			return duk__prop_defown_update_keep_data(thr, idx_desc, defprop_flags, pv_slot, attr_slot, attrs, curr_configurable, have_shifted);
		}
	}
}

DUK_LOCAL duk_bool_t duk__prop_defown_strkey_ordinary(duk_hthread *thr, duk_hobject *obj, duk_hstring *key, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	...
	if (DUK_UNLIKELY(duk_hobject_lookup_strprop_index(thr, obj, key, &ent_idx))) {
		...
		ent_idx = duk_hobject_alloc_strentry_checked(thr, obj, key);
		val_base = (duk_propvalue *) (void *) obj->props;
		key_base = (duk_hstring **) (void *) (val_base + obj->e_size);
		attr_base = (duk_uint8_t *) (void *) (key_base + obj->e_size);
		DUK_ASSERT(key_base[ent_idx] == key);
...
DUK_LOCAL DUK_COLD duk_bool_t duk__prop_defown_strkey_stringobj_length(duk_hthread *thr, duk_hobject *obj, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	duk_hstring *h;
...
DUK_LOCAL DUK_COLD duk_bool_t duk__prop_defown_strkey_bufobj_length(duk_hthread *thr, duk_hobject *obj, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	duk_hbufobj *h;
...
DUK_LOCAL duk_bool_t duk__prop_defown_strkey_array_length(duk_hthread *thr, duk_hobject *obj, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
...
DUK_LOCAL duk_bool_t duk__prop_defown_proxy_tail(duk_hthread *thr, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	duk_bool_t trap_ret;

	DUK_ASSERT(thr != NULL);

	duk_prop_frompropdesc_with_idx(thr, idx_desc, (duk_int_t) defprop_flags);
	duk_call_method(thr, 3);  /* [ ... trap handler target key desc ] -> [ ... result ] */

	trap_ret = duk_to_boolean(thr, -1);
	duk_pop_unsafe(thr);
	if (!trap_ret) {
		return 0;
	}
...
DUK_LOCAL duk_small_int_t duk__prop_defown_strkey_proxy(duk_hthread *thr, duk_hobject *obj, duk_hstring *key, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	DUK_ASSERT(thr != NULL);
	DUK_ASSERT(obj != NULL);
	...
	if (duk_proxy_trap_check_strkey(thr, (duk_hproxy *) obj, key, DUK_STRIDX_DEFINE_PROPERTY)) {
		...
		return (duk_small_int_t) duk__prop_defown_proxy_tail(thr, idx_desc, defprop_flags);
	} else {
		return -1;
	}
}

DUK_LOCAL duk_bool_t duk__prop_defown_strkey_helper(duk_hthread *thr, duk_hobject *obj, duk_hstring *key, duk_idx_t idx_desc, duk_uint_t defprop_flags, duk_bool_t side_effect_safe) {
...
DUK_LOCAL duk_bool_t duk__prop_defown_strkey_unsafe(duk_hthread *thr, duk_hobject *obj, duk_hstring *key, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
...
DUK_LOCAL duk_bool_t duk__prop_defown_strkey_safe(duk_hthread *thr, duk_hobject *obj, duk_hstring *key, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
...
DUK_LOCAL duk_bool_t duk__prop_defown_bufobj_write(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_val) {
	...
	if (DUK_LIKELY(idx < DUK_HBUFOBJ_GET_LOGICAL_LENGTH(h))) {
		...
		if (h->buf != NULL && DUK_HBUFOBJ_VALID_BYTEOFFSET_EXCL(h, byte_off + elem_size)) {
...
DUK_LOCAL duk_bool_t duk__prop_defown_idxkey_ordinary(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	duk_uint_fast32_t ent_idx;
	...
	if (DUK_UNLIKELY(duk_hobject_lookup_idxprop_index(thr, obj, idx, &ent_idx))) {
		...
		ent_idx = duk_hobject_alloc_idxentry_checked(thr, obj, idx);
		val_base = (duk_propvalue *) (void *) obj->idx_props;
		key_base = (duk_uarridx_t *) (void *) (val_base + obj->i_size);
		attr_base = (duk_uint8_t *) (void *) (key_base + obj->i_size);
		DUK_ASSERT(key_base[ent_idx] == idx);
...
DUK_LOCAL duk_small_int_t duk__prop_defown_idxkey_array_items_attempt(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	duk_tval *tv_slot;
	duk_tval *tv_val;
	...
	if (DUK_TVAL_IS_UNUSED(tv_slot)) {
		...
		if ((defprop_flags & (DUK_DEFPROP_HAVE_WEC | DUK_DEFPROP_WEC)) !=
		    (DUK_DEFPROP_HAVE_WEC | DUK_DEFPROP_WEC)) {
...
DUK_LOCAL duk_bool_t duk__prop_defown_idxkey_array(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	duk_harray *a = (duk_harray *) obj;
...
DUK_LOCAL duk_small_int_t duk__prop_defown_idxkey_stringobj(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	duk_hstring *h;
...
DUK_LOCAL DUK_NOINLINE duk_bool_t duk__prop_defown_idxkey_arguments(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	duk_hobject *map;
	duk_hobject *env;
	duk_hstring *varname;
	...
	if (is_mapped != 0 &&
	    duk__prop_is_data_descriptor(defprop_flags) &&
		...
		duk_pop_unsafe(thr);
		rc_ordinary = duk__prop_defown_idxkey_array(thr, obj, idx, duk_get_top_index(thr), modified_flags);
		duk_pop_unsafe(thr);
	} else {
	...
	if (is_mapped) {
		...
		if (duk__prop_is_accessor_descriptor(defprop_flags)) {
			...
			if ((defprop_flags & (DUK_DEFPROP_HAVE_WRITABLE | DUK_DEFPROP_WRITABLE)) == DUK_DEFPROP_HAVE_WRITABLE) {
				DUK_D(DUK_DPRINT("delete arguments mapping for index %ld because setting writable=false", (long) idx));
				delete_mapping = 1;
			}
		}
		if (delete_mapping) {
...
DUK_LOCAL duk_small_int_t duk__prop_defown_idxkey_proxy(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	DUK_ASSERT(thr != NULL);
	DUK_ASSERT(obj != NULL);
	DUK_ASSERT(DUK_HOBJECT_GET_HTYPE(obj) == DUK_HTYPE_PROXY);
...
DUK_LOCAL duk_bool_t duk__prop_defown_idxkey_bufobj(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	duk_hbufobj *h = (duk_hbufobj *) obj;
...
DUK_LOCAL duk_bool_t duk__prop_defown_idxkey_helper(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags, duk_bool_t side_effect_safe) {
	duk_small_uint_t htype;
	duk_hobject *target;
	duk_bool_t rc;
...
DUK_LOCAL duk_bool_t duk__prop_defown_idxkey_unsafe(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
#if defined(DUK_USE_PREFER_SIZE)
	return duk__prop_defown_idxkey_safe(thr, obj, idx, idx_desc, defprop_flags);
#else
...
DUK_LOCAL duk_bool_t duk__prop_defown_idxkey_safe(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	return duk__prop_defown_idxkey_helper(thr, obj, idx, idx_desc, defprop_flags, 1 /*side_effect_safe*/);
}

DUK_INTERNAL duk_bool_t duk_prop_defown_strkey(duk_hthread *thr, duk_hobject *obj, duk_hstring *key, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	DUK_ASSERT(thr != NULL);
	DUK_ASSERT(obj != NULL);
	DUK_ASSERT(key != NULL);
	DUK_ASSERT(idx_desc >= 0);
...
DUK_INTERNAL duk_bool_t duk_prop_defown_idxkey(duk_hthread *thr, duk_hobject *obj, duk_uarridx_t idx, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	DUK_ASSERT(thr != NULL);
	DUK_ASSERT(obj != NULL);
	DUK_ASSERT(idx_desc >= 0);
...
DUK_INTERNAL duk_bool_t duk_prop_defown(duk_hthread *thr, duk_hobject *obj, duk_tval *tv_key, duk_idx_t idx_desc, duk_uint_t defprop_flags) {
	duk_bool_t rc;
	duk_hstring *key;
	duk_uarridx_t idx;
