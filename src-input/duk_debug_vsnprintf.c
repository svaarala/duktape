...
DUK_LOCAL const char *duk__bc_optab[256] = {
	...
	"CSVAR_RR", "CSVAR_CR", "CSVAR_RC", "CSVAR_CC", "CLOSURE", "GETVAR", "PUTVAR", "DELVAR",

	"JUMP", "RETREG", "RETUNDEF", "RETCONST", "RETCONSTN", "LABEL", "ENDLABEL", "BREAK",
	"CONTINUE", "TRYCATCH", "ENDTRY", "ENDCATCH", "ENDFIN", "THROW", "CSREG", "EVALCALL",
