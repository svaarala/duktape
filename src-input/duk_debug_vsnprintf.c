...
DUK_LOCAL const char *duk__bc_optab[256] = {
	...
	"SETALEN", "INITENUM", "NEXTENUM", "NEWTARGET", "DEBUGGER", "NOP", "INVALID", "UNUSED191",

	"CALL0", "CALL1", "CALL2", "CALL3", "CALL4", "CALL5", "CALL6", "CALL7",
	"CALL8", "CALL9", "CALL10", "CALL11", "CALL12", "CALL13", "CALL14", "CALL15",
	"CALLPROP0", "CALLPROP1", "CALLPROP2", "CALLPROP3", "CALLPROP4", "CALLPROP5", "CALLPROP6", "CALLPROP7",
	"CALLPROP8", "CALLPROP9", "CALLPROP10", "CALLPROP11", "CALLPROP12", "CALLPROP13", "CALLPROP14", "CALLPROP15",
