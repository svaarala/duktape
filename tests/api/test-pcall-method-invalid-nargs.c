...
static duk_ret_t test_nargs_negative_minus1(duk_context *ctx) {
	duk_int_t rc;
...
static duk_ret_t test_nargs_negative_minus2(duk_context *ctx) {
	duk_int_t rc;
...
static duk_ret_t test_nargs_negative_minus3(duk_context *ctx) {
	duk_int_t rc;
