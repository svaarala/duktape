...
static duk_ret_t test_basic(duk_context *ctx, void *udata) {
	...
	for (i = 0; i < n; i++) {
		...
		buf = duk_opt_buffer_data(ctx, i, &len, (void *) 0x12345678UL, (duk_size_t) 0x87654321UL);
		if (len == 0) {
	...
	buf = duk_opt_buffer_data(ctx, 0, &len, (void *) 123456789UL, (duk_size_t) 987654321UL);
...
static duk_ret_t test_null_ptr(duk_context *ctx, void *udata) {
	...
	p = duk_opt_buffer_data(ctx, -1, NULL, (void *) 0x12345678UL, (duk_size_t) 0x87654321UL);
	if (p) {
...
static duk_ret_t test_slice(duk_context *ctx, void *udata) {
	...
	p = duk_opt_buffer_data(ctx, -1, &sz, (void *) 0x12345678UL, (duk_size_t) 0x87654321UL);
	if (p) {
