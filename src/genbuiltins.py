...
bi_array_prototype = {
	...
	'functions': [
		...
		{ 'name': 'indexOf',			'native': 'duk_builtin_array_prototype_index_of',		'length': 1,	'nargs': 2 },
		{ 'name': 'lastIndexOf',		'native': 'duk_builtin_array_prototype_last_index_of',		'length': 1,	'nargs': 2 },
		...
		{ 'name': 'reduce',			'native': 'duk_builtin_array_prototype_reduce',			'length': 1,	'nargs': 2 },
		{ 'name': 'reduceRight',		'native': 'duk_builtin_array_prototype_reduce_right',		'length': 1,	'nargs': 2 },
	],
}
